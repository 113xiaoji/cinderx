...
TEST_F(LIRPostGenerationRewriteTest, RewritesCompareFeedingCondBranch) {
  const char* lir_input_str = R"(Function:
BB %0 - succs: %1 %2
  %10:64bit = Move 1
  %11:64bit = Move 2
  %12:8bit = Equal %10, %11
  CondBranch %12, BB%1, BB%2
BB %1
  Return %10
BB %2
  Return %11
...
BB %0 - succs: %1 %2
      %10:64bit = Move 1(0x1):64bit
      %11:64bit = Move 2(0x2):64bit
                   Cmp %10:64bit, %11:64bit
                   BranchE
...
TEST_F(LIRPostGenerationRewriteTest, RetainsSharedCompareBoolResult) {
  const char* lir_input_str = R"(Function:
BB %0 - succs: %1 %2
  %10:64bit = Move 1
  %11:64bit = Move 2
...
BB %0 - succs: %1 %2
      %10:64bit = Move 1(0x1):64bit
      %11:64bit = Move 2(0x2):64bit
      %12:32bit = Equal %10:64bit, %11:64bit
                   CondBranch %12:32bit, BB%1, BB%2
